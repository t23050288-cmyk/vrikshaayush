...
public final class ActivityHistoryBinding implements ViewBinding {
  ...
  private ActivityHistoryBinding(@NonNull CoordinatorLayout rootView, @NonNull Button btnBack,
      @NonNull EditText etSearch, @NonNull FloatingActionButton fabScan,
      @NonNull LinearLayout layoutEmpty, @NonNull RecyclerView rvHistory) {
  ...
  public static ActivityHistoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityHistoryBinding((CoordinatorLayout) rootView, btnBack, etSearch, fabScan,
          layoutEmpty, rvHistory);
    }
